...
public class NavDrawerActivity extends Activity implements
	...
	/**
	 * Back button does returns to the home page, then quits the app.
	 */
	@Override
	public void onBackPressed() {
		if (currentNavPosition == NAV_POSITION_MAIN) {
	...
	public void onNavigationDrawerItemSelected(int position) {
		...
		if (intent == null) {
			Util.toast(getBaseContext(), "Task at position #" + position
					+ " coming soon :)");
			return;
		}
		startActivity(intent);
